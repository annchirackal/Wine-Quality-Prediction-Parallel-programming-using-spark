...
val = spark.read.format("csv").load("s3://winepredict/ValidationDataset.csv", header=True, sep=";")
val.printSchema()
val.show()
...
RFModel = RandomForestModel.load(sc, "s3://winepredict/trainingmodel.model")
